...
K = tf.keras.backend
k_layers = tf.keras.layers
activations, initializers, regularizers, constraints = tf.keras.activations, tf.keras.initializers, tf.keras.regularizers, tf.keras.constraints
...
class QRNN(tf.keras.layers.Layer):
    ...
    def __init__(self, units, window_size=2, stride=1,
                 ...
                 stateful=False, unroll=False, activation='tanh', recurrent_activation='tanh',
                 kernel_initializer='uniform', bias_initializer='zero',
                 kernel_regularizer=None, bias_regularizer=None,
                 activity_regularizer=None,
                 kernel_constraint=None, bias_constraint=None, recurrent_constraint=None,
    ...
    def build(self, input_shape):
        ...
        self.input_spec = tf.keras.layers.InputSpec(shape=(batch_size, None, self.input_dim))
        self.state_spec = tf.keras.layers.InputSpec(shape=(batch_size, self.units))
...
class TiedEmbeddingsTransposed(tf.keras.layers.Layer):
